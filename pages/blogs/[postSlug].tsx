...
export const getStaticPaths: GetStaticPaths = () => {
  ...
  // fallback options
  // false => this will return 404 page for new unkknown slug
  // blocking => this iwll first see the slug and it will try to get data from staic pages and if there is a page it will first hang the browser and try to generate new page
  // true => return the fake page for some time and once the data is ready it will serve them page props

  return {
    paths,
    fallback: "blocking", // we will come to this later with examples.
  };
};
